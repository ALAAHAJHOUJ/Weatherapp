...
const divfils1=useRef();
  ...
  return (
          <>
           {props.nonautorise==true?<div ref={divpere1} onClick={(e)=>{if(e.target==divpere1.current) props.nettoyer2();}} className="absolute left-0 top-0 bg-[#00000078] flex justify-center items-center w-[100vw] h-[100vh]">
